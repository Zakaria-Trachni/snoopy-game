#include "snoopy_dernier_vers.h"

// Fonction pour créer un nœud de score
...
// Fonction pour insérer un score dans l'arbre
...
// Fonction pour empiler une position du joueur
...
// Fonction pour dépiler une position du joueur
...
// Fonction pour vérifier si l'historique des positions du joueur est vide
int isPlayerHistoryEmpty(Player* top) {
    return top == NULL;
}

// Fonction pour créer une file de risques
...
// Fonction pour ajouter un risque à la file
...
// Fonction pour effacer les risques de l'écran
...
// Fonction pour mettre à jour les risques
...
// Fonction pour libérer la mémoire de la file de risques
...
// Fonction pour vérifier si le joueur entre en collision avec un risque
...
// Fonction pour supprimer un risque de la file
...
// Fonction pour gérer les risques
...
// Fonction pour créer les directions de la balle
...
// Fonction pour définir la couleur du texte en rouge
void setRedColor() {
    printf("\e[0;31m");
}
...
// Fonction pour générer une graine aléatoire
...
// Fonction pour définir les positions poussables
...
// Fonction pour afficher les vies restantes
...
// Fonction pour afficher le numéro du niveau
void printLevelNumber(int levelNumber) {
    moveCursor(1, 2);
    printf("\n\t\t Level: %d", levelNumber);
}

// Fonction pour définir la direction de la balle
...
// Fonction pour définir la trajectoire de la balle
...
// Fonction pour afficher le numéro 1
void printNumberOne() {
    printf("\n");
    moveCursor(25, 7);
    printf("     ,---, \n");
...
// Fonction pour afficher le numéro 2
void printNumberTwo() {
    printf("\n");
    int x = 25, y = 7;
    moveCursor(x, y++);
...
// Fonction pour afficher le numéro 3
...
// Fonction pour afficher l'animation du menu principal
...
// Fonction pour obtenir le prochain mouvement du joueur
...
// Fonction pour vérifier la collision entre la balle et le joueur ou les oiseaux
...
// Fonction pour vérifier la collision entre le joueur et les oiseaux
...
// Fonction pour libérer l'historique des positions du joueur
...
// Fonction pour libérer l'historique des positions de la balle
...
// Fonction pour libérer les cœurs
...
// Fonction pour libérer les oiseaux
...
// Fonction principale pour jouer un niveau
int playLevel(int levelNumber, ScoreNode** scoreTree, int* totalScore) {
    ...
    removeRisk(riskQueue, player->x, player->y); // Supprime le risque aprcs collision
}
